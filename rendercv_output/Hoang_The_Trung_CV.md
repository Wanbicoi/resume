...
- **Project: SaaS System Maintenance & Reliability**
  ...
  * Collaborate daily with **US-based engineering teams** through technical discussions, documentation, and sprint ceremonies to align feature implementation and production support activities.

  * Manage **release cycles** across backend services, web applications, and mobile builds.
...
- Integrate a **QR-based voucher system** into Zalo MiniApp to support digital customer acquisition campaigns.



# Education
## **VNUHCM - University of Science**, Bachelor in Information Technology (Honors Program)Sept 2021 – Dec 2025
